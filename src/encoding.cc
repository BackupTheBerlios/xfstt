 ...
 *
 * $Id: encoding.cc,v 1.3 2002/12/29 06:29:29 guillem Exp $
 *
...
{
public:
	iso8859_14(): Encoding("iso8859-14") {}
	int map2unicode(int code);
} exemplar_iso8859_14;

int
iso8859_14::map2unicode(int code)
{
	static unsigned short table[] = {
		...
		0x00c8, 0x00c9, 0x00ca, 0x00cb, 0x00cc, 0x00cd, 0x00ce, 0x00cf,
		0x0174, 0x00d1, 0x00d2, 0x00d3, 0x00d4, 0x0150, 0x00d6, 0x1e6a,
